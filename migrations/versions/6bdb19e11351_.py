...
def upgrade():
    ...
    op.create_table('candidate_dispositions',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('public_id', sa.String(length=100), nullable=True),
    sa.Column('inserted_on', sa.DateTime(), nullable=False),
    sa.Column('type', sa.Enum('lead', 'client', name='clienttype'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['disposition_id'], ['client_dispositions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('public_id')
    )
    ...
    sa.ForeignKeyConstraint(['session_id'], ['docusign_session.id'], ),
    sa.PrimaryKeyConstraint('id'),
