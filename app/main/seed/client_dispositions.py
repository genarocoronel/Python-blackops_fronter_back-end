...
client_dispositions = [
    ...
    {"value": 'Paying off debt on their own',"select_type": 'MANUAL', "name":'Sales_DeadStatus_PayingOffDebtOnTheirOwn' },
    {"value": 'Debt does not qualify',"select_type": 'MANUAL', "name":'Sales_DeadStatus_DebtDoesNotQualify' },
    {"value": 'Not enough debt',"select_type": 'MANUAL', "name":'Sales_DeadStatus_NotEnoughDebt' },
    {"value": 'No contact-Not Pitched',"select_type": 'MANUAL', "name":'Sales_DeadStatus_NoContact_NotPitched' },
    {"value": 'Pitched DV then no contact',"select_type": 'MANUAL', "name":'Sales_DeadStatus_PitchedDV_ThenNoContact' },
    {"value": 'Partial Pitch then no contact',"select_type": 'MANUAL', "name":'Sales_DeadStatus_PartialPitch_ThenNoContact' },
    {"value": 'Heater',"select_type": 'MANUAL', "name":'Sales_DeadStatus_Heater'}
]
