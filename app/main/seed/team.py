...
def seed_team_request_types():
    records = [
        ...
        {'code': 'TERM_CHANGE', 'title': 'Receive Summon', 'doc_sign': True, 'description': 'Receive Summon of the existing debts'},
        {'code': 'RECIEVE_SUMMON', 'title': 'Term Change', 'doc_sign': True, 'description': 'Change in number of monthly terms'},
